...
public class AdGallery extends Gallery implements
     ...
     *
     * @param ads        图片数据数组
     * @param switchTime 图片切换间隔
     * @param l_margin_p 图片到距离屏幕左边界距离占屏幕的"比例"
     * @param t_margin_p 图片到距离屏幕上边界距离占屏幕的"比例"
     * @param w_percent  图片占屏幕的宽度"比例"
     * @param h_percent  图片占屏幕的高度"比例"
     */
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        if (position % 3 == 0) {
            Intent i = new Intent();
            i.setClassName("com.yichang.kaku", "com.yichang.kaku.home.YouHuiQuanLingActivity");
            mContext.startActivity(i);
        } else if (position % 3 == 1) {
            Intent i = new Intent();
            i.setClassName("com.yichang.kaku", "com.yichang.kaku.home.baoyang.BaoYangActivity");
            mContext.startActivity(i);
        } else if (position % 3 == 2) {
            Intent i = new Intent();
            i.setClass(mContext, MyWebViewActivity.class);
            i.putExtra("url", "http://www.99kaku.com/public/index.php/appweb/giti_tire");
            mContext.startActivity(i);
        } else {
            Intent i = new Intent();
            i.setClass(mContext, MyWebViewActivity.class);
        ...
        Log.e("KaKu", "position:" + position % 3);
    }
}
