...
public class OrderDetailFActivity extends BaseActivity implements OnClickListener {
    ...
    private TextView tv_A_jifen, tv_A_shangpinzonge, tv_A_daochefuwufei, tv_A_jianjifen, tv_A_jianyouhuiquan,
            tv_A_shifukuan, tv_A_ordertime, tv_A_zhipaiweixiugong, tv_A_callman,tv_A_yuyuetime,tv_A_yuyuema;
    private Button btn_A_quxiaodingdan, btn_A_lijizhifu;
    //    首减金额，满减金额
    private RelativeLayout rela_shoujian, rela_manjian, rela_F_shangmenfuwufei;
    ...
    //    优惠券信息
    private TextView tv_F_youhuiquan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderdetailf);
        init();
    }
    ...
    private void init() {
        ...
        title.setText("申请取消");
        tv_A_dingdanhao = (TextView) findViewById(R.id.tv_F_dingdanhao);
        tv_A_shopname = (TextView) findViewById(R.id.tv_F_shopname);
        tv_A_time = (TextView) findViewById(R.id.tv_F_time);
        tv_A_point = (TextView) findViewById(R.id.tv_F_point);
        tv_A_dan = (TextView) findViewById(R.id.tv_F_dan);
        tv_A_daochefuwu = (TextView) findViewById(R.id.tv_F_daochefuwu);
        tv_A_addr = (TextView) findViewById(R.id.tv_F_addr);
        tv_A_daoche = (TextView) findViewById(R.id.tv_F_daoche);
        tv_A_phone = (TextView) findViewById(R.id.tv_F_phone);
        tv_A_addrmy = (TextView) findViewById(R.id.tv_F_addrmy);
        tv_A_zhifufangshi = (TextView) findViewById(R.id.tv_F_zhifufangshi);
        //tv_A_fapiaocaizhi= (TextView) findViewById(R.id.tv_F_fapiaocaizhi);
        tv_A_fapiaotaitou = (TextView) findViewById(R.id.tv_F_fapiaotaitou);
        //tv_A_fapiaomingxi= (TextView) findViewById(R.id.tv_F_fapiaomingxi);
        //tv_A_state = (TextView) findViewById(R.id.tv_F_state);
        tv_A_shifukuan = (TextView) findViewById(R.id.tv_F_shifukuan);
        tv_A_callman = (TextView) findViewById(R.id.tv_F_callman);
        tv_A_zhipaiweixiugong = (TextView) findViewById(R.id.tv_F_zhipaiweixiugong);
        tv_A_daochefuwufei = (TextView) findViewById(R.id.tv_F_daochefuwufei);
        tv_A_jianyouhuiquan = (TextView) findViewById(R.id.tv_F_jianyouhuiquan);
        //tv_A_jianjifen= (TextView) findViewById(R.id.tv_F_jianjifen);
        tv_A_shangpinzonge = (TextView) findViewById(R.id.tv_F_shangpinzonge);
        tv_A_remark = (TextView) findViewById(R.id.tv_F_remark);
        tv_A_ordertime = (TextView) findViewById(R.id.tv_F_ordertime);
        tv_A_yuyuetime = (TextView) findViewById(R.id.tv_F_yuyuetime);
        tv_A_yuyuema = (TextView) findViewById(R.id.tv_F_yuyuema);
        //tv_A_jifen= (TextView) findViewById(R.id.tv_F_jifen);
        iv_A_image = (ImageView) findViewById(R.id.iv_F_image);
        iv_A_call = (ImageView) findViewById(R.id.iv_F_call);
        iv_A_call.setOnClickListener(this);
        iv_A_callman = (ImageView) findViewById(R.id.iv_F_callman);
        iv_A_callman.setOnClickListener(this);
        star_A_shop = (RatingBar) findViewById(R.id.star_F_shop);
        iv_A_piao = (ImageView) findViewById(R.id.iv_F_piao);
        iv_A_bao = (ImageView) findViewById(R.id.iv_F_bao);
        iv_A_pei = (ImageView) findViewById(R.id.iv_F_pei);
        iv_A_fu = (ImageView) findViewById(R.id.iv_F_fu);
        iv_A_yuyuema = (ImageView) findViewById(R.id.iv_F_yuyuema);
        lv_A_baoyang = (ListView) findViewById(R.id.lv_F_baoyang);
        ...
        rela_F_shangmenfuwufei = (RelativeLayout) findViewById(R.id.rela_F_shangmenfuwufei);
    ...
    private void initHiddenViews() {
        ...
        tv_F_youhuiquan = (TextView) findViewById(R.id.tv_F_youhuiquan);
    }
    @Override
    public void onClick(View v) {
        ...
        if (R.id.tv_left == id) {
            finish();
        } else if (R.id.iv_F_call == id) {
            Call(phone);
        } else if (R.id.iv_F_callman == id) {
            Call(phoneman);
        }
    }
    ...
    public void OrderDetail() {
        ...
        req.code = "40022";
        req.id_order = KaKuApplication.id_orderF;
                ...
                if (t != null) {
                    ...
                    if (Constants.RES.equals(t.res)) {
                        ...
                        if ("N".equals(t.order.getType_service())) {
                            ...
                            rela_F_shangmenfuwufei.setVisibility(View.GONE);
                            ...
                            rela_F_shangmenfuwufei.setVisibility(View.VISIBLE);
                            view_shangmenfuwufei.setVisibility(View.VISIBLE);
                            tv_A_daoche.setText("上门");
                        }
                        //tv_A_state.setText("申请取消");
                        ...
                        if (TextUtils.isEmpty(t.order.getCoupon_content())) {
                            ...
                            tv_F_youhuiquan.setText(t.order.getCoupon_content());
                        }
                        //初始化首减满减信息
