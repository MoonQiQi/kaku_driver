...
public class YueActivity extends BaseActivity implements OnClickListener {
    ...
    private TextView tv_yue_yue, tv_yue_left_down, tv_yue_right_down, tv_yue_keyi;
    ...
    private void init() {
        ...
        tv_yue_keyi = (TextView) findViewById(R.id.tv_yue_keyi);
            ...
            public void onSucceed(int what, Response response) {
                ...
                if (t != null) {
                    ...
                    if (Constants.RES.equals(t.res)) {
                        float a = Float.parseFloat(t.money_balance) + Float.parseFloat(t.money_balance_brand);
                        tv_yue_yue.setText("¥ " + a);
                        tv_yue_keyi.setText("可提现 ¥ " + t.money_balance);
