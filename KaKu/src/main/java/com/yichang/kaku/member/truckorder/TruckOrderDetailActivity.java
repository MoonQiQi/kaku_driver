...
//-余额
    ...
    private void initOrderId() {
        ...
        //tv_truck_order_state = (TextView) findViewById(R.id.tv_truck_order_state);
    ...
    private void getOrderDetailInfo() {
        ...
        KaKuApiProvider.getTruckOrderDetailInfo(req, new BaseCallback<TruckOrderDetailResp>(TruckOrderDetailResp.class) {
            @Override
            public void onSuccessful(int statusCode, Header[] headers, TruckOrderDetailResp t) {
                if (t != null) {
...
//为实付款赋值，在支付完成回调页上显示
        ...
        /*desc = "车品商城订单";
        out_trade_no = order.getNo_bill();
        notify_url = KaKuApplication.notify_url;*/
        //KaKuApplication.id_bill=out_trade_no;
    ...
    private void setPageWidget(String state) {
        switch (state) {
//            待付款A，待收货B，物流中C，已签收D，待评价E，已评价F，已取消G，已删除H退换货处理中Z
            case "A":
                tv_truck_paytype.setText("待支付");
    ...
    private void confirmReceiptOrder(String id_bill) {
        ...
        KaKuApiProvider.comfirmReceiptTruckOrder(req, new BaseCallback<TruckOrderConfirmReceiptResp>(TruckOrderConfirmReceiptResp.class) {
            @Override
            public void onSuccessful(int statusCode, Header[] headers, TruckOrderConfirmReceiptResp t) {
                if (t != null) {
    ...
    private void deleteOrder(String id_bill) {
        ...
        KaKuApiProvider.deleteTruckOrder(req, new BaseCallback<TruckOrderDeleteResp>(TruckOrderDeleteResp.class) {
            @Override
            public void onSuccessful(int statusCode, Header[] headers, TruckOrderDeleteResp t) {
                if (t != null) {
    ...
    private void cancleOrder(String id_bill) {
        ...
        KaKuApiProvider.cancleTruckOrder(req, new BaseCallback<TruckOrderCancleResp>(TruckOrderCancleResp.class) {
            @Override
            public void onSuccessful(int statusCode, Header[] headers, TruckOrderCancleResp t) {
                if (t != null) {
