...
public class OrderDetailEActivity extends BaseActivity implements OnClickListener {
    ...
    private TextView tv_A_addrmy, tv_A_zhifufangshi, tv_A_remark, tv_A_daochefuwu,tv_A_yuyuetime,tv_A_yuyuema;
    ...
    private TextView tv_A_jifen, tv_A_shangpinzonge, tv_A_daochefuwufei, tv_A_jianjifen, tv_A_jianyouhuiquan,
            tv_A_shifukuan, tv_A_ordertime, tv_A_zhipaiweixiugong, tv_A_callman;
    private Button btn_A_quxiaodingdan;
    //    首减金额，满减金额
    private RelativeLayout rela_shoujian, rela_manjian, rela_E_shangmenfuwufei;
    ...
    //    优惠券信息
    private TextView tv_E_youhuiquan,tv_orderA_peoname,tv_orderA_peophone;
    ...
    private void init() {
        ...
        title.setText("已评价");
        tv_A_dingdanhao = (TextView) findViewById(R.id.tv_E_dingdanhao);
        tv_A_shopname = (TextView) findViewById(R.id.tv_E_shopname);
        tv_A_time = (TextView) findViewById(R.id.tv_E_time);
        tv_A_point = (TextView) findViewById(R.id.tv_E_point);
        tv_A_dan = (TextView) findViewById(R.id.tv_E_dan);
        tv_A_addr = (TextView) findViewById(R.id.tv_E_addr);
        tv_A_daochefuwu = (TextView) findViewById(R.id.tv_E_daochefuwu);
        tv_A_daoche = (TextView) findViewById(R.id.tv_E_daoche);
        tv_A_phone = (TextView) findViewById(R.id.tv_E_phone);
        tv_A_addrmy = (TextView) findViewById(R.id.tv_E_addrmy);
        tv_A_zhifufangshi = (TextView) findViewById(R.id.tv_E_zhifufangshi);
        //tv_A_fapiaocaizhi= (TextView) findViewById(R.id.tv_E_fapiaocaizhi);
        tv_A_fapiaotaitou = (TextView) findViewById(R.id.tv_E_fapiaotaitou);
        //tv_A_fapiaomingxi= (TextView) findViewById(R.id.tv_E_fapiaomingxi);
        //tv_A_state = (TextView) findViewById(R.id.tv_E_state);
        tv_A_shifukuan = (TextView) findViewById(R.id.tv_E_shifukuan);
        tv_A_callman = (TextView) findViewById(R.id.tv_E_callman);
        tv_A_zhipaiweixiugong = (TextView) findViewById(R.id.tv_E_zhipaiweixiugong);
        tv_A_daochefuwufei = (TextView) findViewById(R.id.tv_E_daochefuwufei);
        tv_A_jianyouhuiquan = (TextView) findViewById(R.id.tv_E_jianyouhuiquan);
        tv_A_yuyuetime = (TextView) findViewById(R.id.tv_E_yuyuetime);
        tv_A_yuyuema = (TextView) findViewById(R.id.tv_E_yuyuema);
        //tv_A_jianjifen= (TextView) findViewById(R.id.tv_E_jianjifen);
        tv_A_shangpinzonge = (TextView) findViewById(R.id.tv_E_shangpinzonge);
        tv_A_remark = (TextView) findViewById(R.id.tv_E_remark);
        tv_A_ordertime = (TextView) findViewById(R.id.tv_E_ordertime);
        //tv_A_jifen= (TextView) findViewById(R.id.tv_E_jifen);
        iv_A_image = (ImageView) findViewById(R.id.iv_E_image);
        iv_A_call = (ImageView) findViewById(R.id.iv_E_call);
        iv_A_call.setOnClickListener(this);
        iv_A_callman = (ImageView) findViewById(R.id.iv_E_callman);
        iv_A_callman.setOnClickListener(this);
        tv_orderA_peoname= (TextView) findViewById(R.id.tv_order_E_peoname);
        tv_orderA_peophone= (TextView) findViewById(R.id.tv_order_E_peophone);
        star_A_shop = (RatingBar) findViewById(R.id.star_E_shop);
        iv_A_piao = (ImageView) findViewById(R.id.iv_E_piao);
        iv_A_bao = (ImageView) findViewById(R.id.iv_E_bao);
        iv_A_pei = (ImageView) findViewById(R.id.iv_E_pei);
        iv_A_fu = (ImageView) findViewById(R.id.iv_E_fu);
        iv_A_yuyuema = (ImageView) findViewById(R.id.iv_E_yuyuema);
        lv_A_baoyang = (ListView) findViewById(R.id.lv_E_baoyang);
        lv_A_baoyang.setFocusable(false);
        btn_A_quxiaodingdan = (Button) findViewById(R.id.btn_E_lijizhifu);
        ...
        rela_E_shangmenfuwufei = (RelativeLayout) findViewById(R.id.rela_E_shangmenfuwufei);
    ...
    private void initHiddenViews() {
        ...
        tv_E_youhuiquan = (TextView) findViewById(R.id.tv_E_youhuiquan);
    }
    @Override
    public void onClick(View v) {
        ...
        if (R.id.tv_left == id) {
            finish();
        } else if (R.id.iv_E_call == id) {
            Call(phone);
        } else if (R.id.iv_E_callman == id) {
            Call(phoneman);
        } else if (R.id.btn_E_lijizhifu == id) {
            DeleteOrder();
        }
    }
    ...
    public void OrderDetail() {
        ...
        req.code = "40022";
        req.id_order = KaKuApplication.id_orderE;
            ...
            public void onSuccessful(int statusCode, Header[] headers, OrderDetailResp t) {
                if (t != null) {
                    ...
                    if (Constants.RES.equals(t.res)) {
                        ...
                        if ("Y".equals(t.order.getType_service())) {
                            ll_arrival_addr.setVisibility(View.GONE);
                            view_arrival_addr.setVisibility(View.GONE);
                            rela_E_shangmenfuwufei.setVisibility(View.GONE);
                            ...
                            rela_E_shangmenfuwufei.setVisibility(View.VISIBLE);
                        ...
                        if (TextUtils.isEmpty(t.order.getCoupon_content())) {
                            ...
                            tv_E_youhuiquan.setText(t.order.getCoupon_content());
                        }
                        //初始化首减满减信息
    ...
    public void DeleteOrder() {
        ...
        req.code = "40017";
        req.id_order = KaKuApplication.id_orderE;
        KaKuApiProvider.DeleteOrder(req, new BaseCallback<DeleteOrderResp>(DeleteOrderResp.class) {
            @Override
            public void onSuccessful(int statusCode, Header[] headers, DeleteOrderResp t) {
                if (t != null) {
                    LogUtil.E("delete res: " + t.res);
                    if (Constants.RES.equals(t.res)) {
