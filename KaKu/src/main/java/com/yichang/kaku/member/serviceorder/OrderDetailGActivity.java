...
public class OrderDetailGActivity extends BaseActivity implements OnClickListener {
    ...
    private ImageView iv_A_image, iv_A_call, iv_A_piao, iv_A_bao, iv_A_pei, iv_A_fu, iv_A_callman;
    ...
    //    首减金额，满减金额
    private RelativeLayout rela_shoujian, rela_manjian, rela_G_daochewufufei;
    ...
    //    优惠券信息
    private TextView tv_G_youhuiquan,tv_orderA_peoname,tv_orderA_peophone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderdetailg);
        init();
    }
    ...
    private void init() {
        ...
        title.setText("已取消");
        tv_A_dingdanhao = (TextView) findViewById(R.id.tv_G_dingdanhao);
        tv_A_shopname = (TextView) findViewById(R.id.tv_G_shopname);
        tv_A_time = (TextView) findViewById(R.id.tv_G_time);
        tv_A_point = (TextView) findViewById(R.id.tv_G_point);
        tv_A_dan = (TextView) findViewById(R.id.tv_G_dan);
        tv_A_addr = (TextView) findViewById(R.id.tv_G_addr);
        tv_A_daoche = (TextView) findViewById(R.id.tv_G_daoche);
        tv_A_phone = (TextView) findViewById(R.id.tv_G_phone);
        tv_A_addrmy = (TextView) findViewById(R.id.tv_G_addrmy);
        tv_A_zhifufangshi = (TextView) findViewById(R.id.tv_G_zhifufangshi);
        tv_orderA_peoname= (TextView) findViewById(R.id.tv_order_G_peoname);
        tv_orderA_peophone= (TextView) findViewById(R.id.tv_order_G_peophone);
        //tv_A_fapiaocaizhi= (TextView) findViewById(R.id.tv_G_fapiaocaizhi);
        tv_A_fapiaotaitou = (TextView) findViewById(R.id.tv_G_fapiaotaitou);
        //tv_A_fapiaomingxi= (TextView) findViewById(R.id.tv_G_fapiaomingxi);
        //tv_A_state = (TextView) findViewById(R.id.tv_G_state);
        tv_A_daochefuwu = (TextView) findViewById(R.id.tv_G_daochefuwu);
        tv_A_shifukuan = (TextView) findViewById(R.id.tv_G_shifukuan);
        tv_A_daochefuwufei = (TextView) findViewById(R.id.tv_G_daochefuwufei);
        tv_A_jianyouhuiquan = (TextView) findViewById(R.id.tv_G_jianyouhuiquan);
        //tv_A_jianjifen= (TextView) findViewById(R.id.tv_G_jianjifen);
        tv_A_shangpinzonge = (TextView) findViewById(R.id.tv_G_shangpinzonge);
        tv_A_remark = (TextView) findViewById(R.id.tv_G_remark);
        tv_A_ordertime = (TextView) findViewById(R.id.tv_G_ordertime);
        //tv_A_jifen= (TextView) findViewById(R.id.tv_G_jifen);
        iv_A_image = (ImageView) findViewById(R.id.iv_G_image);
        iv_A_call = (ImageView) findViewById(R.id.iv_G_call);
        iv_A_call.setOnClickListener(this);
        star_A_shop = (RatingBar) findViewById(R.id.star_G_shop);
        iv_A_piao = (ImageView) findViewById(R.id.iv_G_piao);
        iv_A_bao = (ImageView) findViewById(R.id.iv_G_bao);
        iv_A_pei = (ImageView) findViewById(R.id.iv_G_pei);
        iv_A_fu = (ImageView) findViewById(R.id.iv_G_fu);
        lv_A_baoyang = (ListView) findViewById(R.id.lv_G_baoyang);
        lv_A_baoyang.setFocusable(false);
        btn_A_lijizhifu = (Button) findViewById(R.id.btn_G_lijizhifu);
        ...
        rela_G_daochewufufei = (RelativeLayout) findViewById(R.id.rela_G_daochewufufei);
...
//初始化到车服务地址
    ...
    private void  initHiddenViews(){
        ...
        tv_G_youhuiquan = (TextView) findViewById(R.id.tv_G_youhuiquan);
    }
    @Override
    public void onClick(View v) {
        ...
        if (R.id.tv_left == id) {
            finish();
        } else if (R.id.iv_G_call == id) {
            Call(phone);
        } else if (R.id.btn_G_lijizhifu == id) {
            DeleteOrder();
        }
    }
    ...
    public void OrderDetail() {
        ...
        req.code = "40022";
        req.id_order = KaKuApplication.id_orderG;
                ...
                if (t != null) {
                    ...
                    if (Constants.RES.equals(t.res)) {
                        ...
                        if ("N".equals(t.order.getType_service())) {
                            ...
                            rela_G_daochewufufei.setVisibility(View.GONE);
                            ...
                            rela_G_daochewufufei.setVisibility(View.VISIBLE);
                            view_shangmenfuwufei.setVisibility(View.VISIBLE);
                        }
                        //tv_A_state.setText("已取消");
                        ...
                        if ("Y".equals(t.order.getType_service())) {
                            tv_A_daoche.setVisibility(View.VISIBLE);
                        } else {
                            tv_A_daoche.setVisibility(View.GONE);
                        }
                        ...
                        if (TextUtils.isEmpty(t.order.getCoupon_content())) {
                            ...
                            tv_G_youhuiquan.setText(t.order.getCoupon_content());
                        }
                        //初始化首减满减信息
