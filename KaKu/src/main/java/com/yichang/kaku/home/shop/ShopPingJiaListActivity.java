...
public class ShopPingJiaListActivity extends BaseActivity implements OnClickListener{
    ...
    private void setData(List<PingJiaObj> list) {
        ...
        PingJiaAdapter adapter = new PingJiaAdapter(ShopPingJiaListActivity.this, list_pingjia);
