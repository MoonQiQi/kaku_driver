...
public class CheXiAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private List<SeriesObj> list;
    private Context mContext;

    public CheXiAdapter(Context context, List<SeriesObj> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        SeriesObj obj = list.get(position);
        if (obj == null) {
            return convertView;
        }
        if (convertView == null) {
        ...
        holder.tv_item_chexi.setText(obj.getName_series());
