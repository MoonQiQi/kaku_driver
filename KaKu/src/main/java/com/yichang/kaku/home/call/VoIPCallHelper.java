...
public class VoIPCallHelper implements OnMakeCallBackListener {
    ...
    private VoIPCallHelper() {
        ...
        mUserInfo.setNickName(Utils.getCallName());
        mUserInfo.setPhoneNumber(Utils.getCall());
    }
    ...
    public static void makeCallBack(ECVoIPCallManager.CallType callType, String number) {
        ...
        callBackEntity.caller = Utils.getPhone();
        callBackEntity.callerSerNum = number;


        callBackEntity.called = number;
        callBackEntity.calledSerNum = Utils.getPhone();
    ...
    public static void initCall() {
        ...
        ourInstance.mCallInterface = CallActivity.getVoIPCallManager();
        ourInstance.mCallSetInterface = CallActivity.getVoIPSetManager();
        ...
        if (ourInstance.mCallSetInterface != null) {
            // 设置呼叫参数信息[呼叫昵称、呼叫手机号]
            VoIPCallUserInfo info = new VoIPCallUserInfo(Utils.getPhone(), Utils.getPhone());
