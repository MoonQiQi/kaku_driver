...
public class Add_IActivity extends BaseActivity implements OnClickListener {
    ...
    private ImageView iv_tietieyangshi, iv_shouqi_i;
    ...
    private ScrollView scroll_add_i;
    private View renwushuoming_i, chetiexinxi_i;
        ...
        calendar.setOnItemClickListener(new CalendarView.OnItemClickListener() {
            ...
            public void OnItemClick(String s, String downDate) {
                if (downDate.equals(mPhotoDate)) {
                    //最佳拍照日，弹出拍照对话框
                    AlertDialog.Builder builder = new AlertDialog.Builder(Add_IActivity.this);
                    builder.setTitle("提示");
                    ...
                    builder.setNegativeButton("是", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            // TODO Auto-generated method stub
                            Intent intent = new Intent(Add_IActivity.this, AdImageActivity.class);
...
//			startActivity(new Intent(this, MemberRecommendActivity.class));
            getStickerShareInfo();
        } else if (R.id.btn_add_i == id) {
            Intent intent = new Intent(context, ImageHistoryActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        } else if (R.id.rela_addn_button_i == id) {
            Intent intent = new Intent(context, ImageHistoryActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        } else if (R.id.iv_shouqi_i == id) {
            if (flag_zhankai) {
                iv_shouqi_i.setImageResource(R.drawable.btn_gengduoxiangqing);
                renwushuoming_i.setVisibility(View.GONE);
                chetiexinxi_i.setVisibility(View.GONE);
                flag_zhankai = false;
            } else if (!flag_zhankai) {
                iv_shouqi_i.setImageResource(R.drawable.btn_shouqixiangqing);
                renwushuoming_i.setVisibility(View.VISIBLE);
                chetiexinxi_i.setVisibility(View.VISIBLE);
                flag_zhankai = true;
            }
    ...
    public void SetText() {
        ...
        renwushuoming_i = findViewById(R.id.renwushuoming_i);
        chetiexinxi_i = findViewById(R.id.chetiexinxi_i);
        scroll_add_i = (ScrollView) findViewById(R.id.scroll_add_i);
        ...
        iv_shouqi_i = (ImageView) findViewById(R.id.iv_shouqi_i);
        iv_shouqi_i.setOnClickListener(this);
        rela_chetiexinxi = (RelativeLayout) findViewById(R.id.rela_chetiexinxi);
        rela_addn_button = (RelativeLayout) findViewById(R.id.rela_addn_button_i);
        rela_addn_button.setOnClickListener(this);
        btn_add = (Button) findViewById(R.id.btn_add_i);
        btn_add.setOnClickListener(this);
        rela_chetiexinxi.setClickable(false);

        scroll_add_i.smoothScrollTo(0, 0);
        tv_shouyi_time.setText(time_begin + "至" + time_end);
        String string = "预期总收益：¥ " + total_earning;
        SpannableStringBuilder style = new SpannableStringBuilder(string);
        style.setSpan(new AbsoluteSizeSpan(18, true), 7, string.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
