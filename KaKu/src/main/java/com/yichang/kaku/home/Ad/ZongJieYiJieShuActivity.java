...
public class ZongJieYiJieShuActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zongjieyijieshu);
        init();
    }
    ...
    private void init() {
        ...
        title.setText("车贴详情");
        tv_E_day = (TextView) findViewById(R.id.tv_EZongJie_day);
        tv_EZongJie_renwushouyi = (TextView) findViewById(R.id.tv_EZongJie_renwushouyi);
        tv_EZongJie_shouyitianshu = (TextView) findViewById(R.id.tv_EZongJie_shouyitianshu);
        tv_EZongJie_rijunshouyi = (TextView) findViewById(R.id.tv_EZongJie_rijunshouyi);
        tv_EZongJie_sijishouyi = (TextView) findViewById(R.id.tv_EZongJie_sijishouyi);
        tv_EZongJie_canyurenshu = (TextView) findViewById(R.id.tv_EZongJie_canyurenshu);
        tv_EZongJie_biaozhun = (TextView) findViewById(R.id.tv_EZongJie_biaozhun);
        tv_EZongJie_rijun = (TextView) findViewById(R.id.tv_EZongJie_rijun);
        btn_EZongJie_chetiedaili = (Button) findViewById(R.id.btn_EZongJie_chetiedaili);
        btn_EZongJie_chetiedaili.setOnClickListener(this);
        iv_EZongJie_head = (CircularImage) findViewById(R.id.iv_EZongJie_head);
        rela_EZongJie_1 = (RelativeLayout) findViewById(R.id.rela_EZongJie_1);
        line_EZongJie_2 = (LinearLayout) findViewById(R.id.line_EZongJie_2);
        view_EZongJie1 = findViewById(R.id.view_EZongJie1);
        view_EZongJie2 = findViewById(R.id.view_EZongJie2);
        iv_YZongJie_image = (ImageView) findViewById(R.id.iv_EZongJie_image);
        iv_YZongJie_shoutie0yuan = (ImageView) findViewById(R.id.iv_EZongJie_shoutie0yuan);
        tv_YZongJie_remark = (TextView) findViewById(R.id.tv_EZongJie_remark);
        tv_YZongJie_tuijianhaoyou = (TextView) findViewById(R.id.tv_EZongJie_tuijianhaoyou);
        tv_YZongJie_shouyiqixian = (TextView) findViewById(R.id.tv_EZongJie_shouyiqixian);
        getZongJie();
    }
    ...
    public void onClick(View v) {
        ...
        if (R.id.tv_left == id) {
            finish();
        } else if (R.id.btn_EZongJie_chetiedaili == id) {
            DaiLi();
        }
    }
