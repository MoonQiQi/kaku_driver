...
public class SouSuoLiShiAdapter extends BaseAdapter {
	...
	public SouSuoLiShiAdapter(Context context, List<String> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.iv_sslishi_cha.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				SharedPreferences sp = mContext.getSharedPreferences("history_strs", 0);
				save_Str = sp.getString("history", "");
