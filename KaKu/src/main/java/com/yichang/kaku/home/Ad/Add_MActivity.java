...
public class Add_MActivity extends BaseActivity implements OnClickListener {
        ...
        calendar.setOnItemClickListener(new CalendarView.OnItemClickListener() {
            ...
            public void OnItemClick(String s, String downDate) {
                ...
                if (downDate.equals(mPhotoDate)) {
                    //最佳拍照日，弹出拍照对话框
                    AlertDialog.Builder builder = new AlertDialog.Builder(Add_MActivity.this);
                    builder.setTitle("提示");
                    ...
                    builder.setNegativeButton("是", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            // TODO Auto-generated method stub
                            Intent intent = new Intent(Add_MActivity.this, AdImageActivity.class);
