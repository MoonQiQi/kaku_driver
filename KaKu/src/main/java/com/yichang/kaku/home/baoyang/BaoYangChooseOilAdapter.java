...
public class BaoYangChooseOilAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private List<BigOilObj> list;
    private Context mContext;

    public BaoYangChooseOilAdapter(Context context, List<BigOilObj> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_baoyangchooseoil, null);
