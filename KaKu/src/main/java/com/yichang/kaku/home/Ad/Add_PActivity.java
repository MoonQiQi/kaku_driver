...
public class Add_PActivity extends BaseActivity implements OnClickListener {
    ...
    private ImageView iv_P_zhizhen, iv_P_state, iv_P_riliyou, iv_P_rilizuo, tv_P_tixian;
    private TextView tv_P_jinrishouyi, tv_P_shengyutianshu, tv_P_zhangfu, tv_P_totalmoney, tv_P_yue;
    private RiseNumberTextView tv_P_shouyi;
    private Button btn_P_paizhao;
    ...
    private void init() {
        ...
        iv_Y_i = (ImageView) findViewById(R.id.iv_P_i);
        iv_Y_i.setOnClickListener(this);
        iv_P_zhizhen = (ImageView) findViewById(R.id.iv_P_zhizhen);
        iv_P_state = (ImageView) findViewById(R.id.iv_P_state);
        iv_P_riliyou = (ImageView) findViewById(R.id.iv_P_riliyou);
        iv_P_rilizuo = (ImageView) findViewById(R.id.iv_P_rilizuo);
        tv_P_shouyi = (RiseNumberTextView) findViewById(R.id.tv_P_shouyi);
        tv_P_zhangfu = (TextView) findViewById(R.id.tv_P_zhangfu);
        tv_P_totalmoney = (TextView) findViewById(R.id.tv_P_totalmoney);
        tv_P_yue = (TextView) findViewById(R.id.tv_P_yue);
        tv_P_tixian = (ImageView) findViewById(R.id.tv_P_tixian);
        tv_P_tixian.setOnClickListener(this);
        ...
        tv_P_jinrishouyi = (TextView) findViewById(R.id.tv_P_jinrishouyi);
        tv_P_shengyutianshu = (TextView) findViewById(R.id.tv_P_shengyutianshu);
        btn_P_paizhao = (Button) findViewById(R.id.btn_P_paizhao);
        btn_P_paizhao.setOnClickListener(this);
        ...
        iv_Y_quanbushouyi = (ImageView) findViewById(R.id.iv_P_quanbushouyi);
        iv_Y_quanbushouyi.setOnClickListener(this);
        iv_Y_paizhaolishi = (ImageView) findViewById(R.id.iv_P_paizhaolishi);
    ...
    public void SetText(final GetAddResp t) {
        ...
        iv_P_riliyou.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                tv_P_yue.setText(yue + "月");

                int index_y = Integer.parseInt(t.index_y);
                list_calendar = t.calendars.get(index_x).week;
                CalendarAdapter adapter_calendar = new CalendarAdapter(Add_PActivity.this, list_calendar, index_y);
                gv_calendar.setAdapter(adapter_calendar);
            }
        });

        iv_P_rilizuo.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (index_x == 0) {
                    return;
        ...
        if ("1".equals(t.advert.getFlag_advert())) {
            ...
            builder.create().show();
        } else if ("2".equals(t.advert.getFlag_advert())) {
            showYuYueWindow();
        ...
        if (t.advert.getNow_earnings().contains(".")) {
            tv_P_shouyi.withNumber(Float.parseFloat(t.advert.getNow_earnings())).start();
        } else {
            tv_P_shouyi.withNumber(Integer.parseInt(t.advert.getNow_earnings())).start();
        }
        title.setText(t.advert.getName_advert());
        tv_P_totalmoney.setText("¥ " + t.advert.getEarnings_total());
        tv_P_zhangfu.setText(t.advert.getDay_growth());
        ...
        tv_P_shengyutianshu.setText(style_day);
        ...
        tv_P_jinrishouyi.setText(style_jinri);
        ...
        iv_P_zhizhen.setAnimation(animation);
        ...
        getWindow().getDecorView().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                YuYueWindow popWindow =
                        new YuYueWindow(Add_PActivity.this);
                popWindow.show();
        ...
        getWindow().getDecorView().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                HongSeWindow popWindow =
                        new HongSeWindow(Add_PActivity.this);
                popWindow.show();
        ...
        getWindow().getDecorView().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                YuEPopWindow popWindow =
                        new YuEPopWindow(Add_PActivity.this, ketixian, buketixian);
                popWindow.show();
