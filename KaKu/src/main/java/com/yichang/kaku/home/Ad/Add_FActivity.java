...
public class Add_FActivity extends BaseActivity implements OnClickListener {
    ...
    private String name_advert, day_earnings, time_begin, time_end, num_driver, free_remind, image_advert,
            image_size, day_continue, day_remaining, total_earning, flag_type, now_earnings, approve_opinions;
    ...
    private ImageView iv_tietieyangshi, iv_shouqi_f;
    ...
    private ScrollView scroll_add_f;
    private View renwushuoming_f, chetiexinxi_f;
    ...
    private void init() {
        ...
        approve_opinions = bundle.getString("approve_opinions");//失败原因
    ...
    private void getCalendarData(String month, String year) {
        ...
        KaKuApiProvider.getCalendarList(req, new BaseCallback<AdCalendarResp>(AdCalendarResp.class) {
            ...
            public void onFailure(int statusCode, Header[] headers, String msg, Throwable error) {
                LogUtil.E("getCalendarList onFailure chaih");
                stopProgressDialog();
            }
        });
    ...
    private void initCalendarView() {
        ...
        calendarLeft.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LogUtil.E("chaih leftYearAndmonth:" + leftYearAndmonth);
        ...
        calendarRight.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LogUtil.E("chaih rightYearAndmonth:" + rightYearAndmonth);
        ...
        calendar.setOnItemClickListener(new CalendarView.OnItemClickListener() {
            ...
            public void OnItemClick(String s, String downDate) {
                if (downDate.equals(mPhotoDate)) {
                    //最佳拍照日，弹出拍照对话框
                    AlertDialog.Builder builder = new AlertDialog.Builder(Add_FActivity.this);
                    builder.setTitle("提示");
                    ...
                    builder.setNegativeButton("是", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            // TODO Auto-generated method stub
                            /*Intent intent=new Intent(Add_FActivity.this,ReImageActivity.class);
    ...
    public void onClick(View v) {
        ...
        if (R.id.tv_left == id) {
           ...
           /* MobclickAgent.onEvent(context, "JinYuanBao");
            ...
            getStickerShareInfo();
        } else if (R.id.btn_add_f == id) {
            reUploadImage();
        } else if (R.id.rela_addn_button_f == id) {
            reUploadImage();
        } else if (R.id.iv_shouqi_f == id) {
            if (flag_zhankai) {
                iv_shouqi_f.setImageResource(R.drawable.btn_gengduoxiangqing);
                renwushuoming_f.setVisibility(View.GONE);
                chetiexinxi_f.setVisibility(View.GONE);
                flag_zhankai = false;
            } else if (!flag_zhankai) {
                iv_shouqi_f.setImageResource(R.drawable.btn_shouqixiangqing);
                renwushuoming_f.setVisibility(View.VISIBLE);
                chetiexinxi_f.setVisibility(View.VISIBLE);
                flag_zhankai = true;
            }
    ...
    private void reUploadImage() {
        KaKuApplication.reason_upload = approve_opinions;
        Intent intent = new Intent(this, ReImageActivity.class);
    ...
    public void SetText() {
        ...
        renwushuoming_f = findViewById(R.id.renwushuoming_f);
        chetiexinxi_f = findViewById(R.id.chetiexinxi_f);
        scroll_add_f = (ScrollView) findViewById(R.id.scroll_add_f);
        ...
        iv_shouqi_f = (ImageView) findViewById(R.id.iv_shouqi_f);
        iv_shouqi_f.setOnClickListener(this);
        rela_chetiexinxi = (RelativeLayout) findViewById(R.id.rela_chetiexinxi);
        rela_addn_button = (RelativeLayout) findViewById(R.id.rela_addn_button_f);
        rela_addn_button.setOnClickListener(this);
        btn_add = (Button) findViewById(R.id.btn_add_f);
        btn_add.setOnClickListener(this);
        rela_chetiexinxi.setClickable(false);

        scroll_add_f.smoothScrollTo(0, 0);
