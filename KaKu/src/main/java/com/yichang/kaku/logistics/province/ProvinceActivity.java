...
public class ProvinceActivity extends BaseActivity implements OnClickListener,AdapterView.OnItemClickListener{
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		KaKuApplication.province_addr = list_province.get(position).getId_area();
		KaKuApplication.province_addrname = list_province.get(position).getName_area();
