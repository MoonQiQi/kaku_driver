...
public class BorderScrollView extends ScrollView {
    ...
    private void doOnBorderListener() {
        ...
        if (contentView != null && (contentView.getMeasuredHeight()+300 )<= getScrollY() + getHeight()) {
            LogUtil.E("contentView.getMeasuredHeight()+300 "+contentView.getMeasuredHeight()+300  );
            LogUtil.E("getScrollY() + getHeight() "+getScrollY() + getHeight() );
            if (onBorderListener != null) {
