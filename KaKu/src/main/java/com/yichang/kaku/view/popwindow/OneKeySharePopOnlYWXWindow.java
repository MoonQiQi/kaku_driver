 ...
 */
public class OneKeySharePopOnlYWXWindow extends PopupWindow implements View.OnClickListener {
    ...
    public OneKeySharePopOnlYWXWindow(BaseActivity context, ShareContentObj shareContent) {
        super(context);
