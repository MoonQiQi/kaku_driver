...
public class AddAndSubView extends LinearLayout
{
	...
	private void initialise()
	{
		...
		editText.setTextColor(context.getResources().getColor(R.color.text_gray));
		editText.setBackgroundResource(R.drawable.textbg);
		//addButton.setText("-");
		addButton.setBackgroundResource(R.drawable.fuhao_jia2);
		//subButton.setText("+");
		subButton.setBackgroundResource(R.drawable.fuhao_jian2);
		addButton.setTag("-");
		subButton.setTag("+");
		//设置输入类型为数字
	...
	{
		LayoutParams viewLayoutParams = new LayoutParams(60,60);
		...
		viewLayoutParams.width = 60;//LinearLayout.LayoutParams.WRAP_CONTENT;
