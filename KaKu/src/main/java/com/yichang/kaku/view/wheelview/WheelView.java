...
package com.yichang.kaku.view.wheelview;
...
import com.yichang.kaku.view.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void initData(Context context) {
        ...
        itemParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, (int) (getResources().getDisplayMetrics().density * 30));
    }
    ...
    public void setWheelForegroundColor(int color) {
...
//        if (drawShadows) drawShadows(canvas);
    ...
    private boolean addViewItem(int index, boolean first) {
        ...
        if (view != null) {
            if (first) {
                itemsLayout.addView(view, 0, itemParams);
            } else {
                itemsLayout.addView(view, itemParams);
            }
            return true;
        }
        return false;
