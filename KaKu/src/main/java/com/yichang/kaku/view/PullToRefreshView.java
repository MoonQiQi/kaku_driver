...
public class PullToRefreshView extends LinearLayout {
	...
	/**
	 * todo delete by chaih 20150825 header tip text
	 */
	//private TextView mHeaderTextView;
	/**
	 * footer tip text
	 * todo delete by chaih 20150825
	 */
	...
	private void addHeaderView() {
		...
		//todo mHeaderTextView = (TextView) mHeaderView.findViewById(R.id.pull_to_refresh_text);
